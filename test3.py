...
if __name__ == '__main__':
    n = 20
    class_list = np.loadtxt(f"/home/ubuntu/datasets/SIGVerse/trial3_phrase/noisy_class_list/class_list.txt", delimiter=',', dtype=str)[1:]
    labels = np.genfromtxt(f"/home/ubuntu/datasets/SIGVerse/trial3_phrase/noisy_label/label_100.csv", delimiter=',').astype(np.int)
    labels = labels[:, 1:]
